...
df1_1
p1_1 <- ggplot(df1_1, aes(x = group, y = empathic_motives, fill = group)) + scale_y_continuous(breaks = seq(36, 41, 1))
pa1_1 = p1_1 + geom_bar(stat= "identity", position = "dodge") + geom_errorbar(aes(ymin = empathic_motives - se, ymax = empathic_motives + se), position = "dodge", width = 0.2) + labs(y= "Empathic Motives", x = "Groups")
pa1_1

df1_2 = ddply(dat, "group", summarise, mean=mean(empathy), sd=sd(empathy), n=length(empathy), se=sd/sqrt(n))
colnames(df1_2)[2] = "empathy"
df1_2
p1_2 <- ggplot(df1_2, aes(x = group, y = empathy, fill = group)) + scale_y_continuous(breaks = seq(20, 60, 10))
pa1_2 = p1_2 + geom_bar(stat= "identity", position = "dodge") + geom_errorbar(aes(ymin = empathy - se, ymax = empathy + se), position = "dodge", width = 0.2) + labs(y= "Empathy", x = "Groups")
pa1_2
...
df1_3
p1_3 <- ggplot(df1_3, aes(x = group, y = prosocial_behavior, fill = group)) + scale_y_continuous(breaks = seq(0, 20000, 2000))
pa1_3 = p1_3 + geom_bar(stat= "identity", position = "dodge") + geom_errorbar(aes(ymin = prosocial_behavior - se, ymax = prosocial_behavior + se), position = "dodge", width = 0.2) + labs(y= "Hypothetical Prosocial Behavior", x = "Groups")
pa1_3
```
