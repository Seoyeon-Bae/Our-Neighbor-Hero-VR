...
df1_3
p1_3 <- ggplot(df1_3, aes(x = group, y = prosocial_behavior, fill = group)) + scale_x_discrete(labels = c("Combined", "VR-only")) + scale_y_continuous(breaks = seq(0, 20000, 2000))
